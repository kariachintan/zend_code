...
class referencelibrary_forms_library_Details extends referencelibrary_forms_abstract_AttachmentTarget {
    ...
    public function build() {
        ...
        $element->setRequired(true);
        $element->setMultiOptions($codes->getOptionsByCodeName(Core_Config::get('referencelibrary', 'codes_reference_doctypes')));
        $this->addElement($element);

        $element = new Core_Form_Element_Select('DocPriorityId');
        $element->setLabel('Document Priority Type');
        $element->setRequired(true);
        $element->setMultiOptions($codes->getOptionsByCodeName(Core_Config::get('referencelibrary', 'codes_reference_docprioritytypes')));
        $this->addElement($element);
