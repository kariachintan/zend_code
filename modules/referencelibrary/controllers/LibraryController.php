...
class referencelibrary_LibraryController extends Core_Controller_Action {
    ...
    public function postPersist(){
          ...
          if($this->id)
          {
                ...
                $docTypeCodePublic =  $codes->getCodeIdByCodeName(Core_Config::get('referencelibrary', 'codes_reference_doctypes_public'));
            ...
            else
            {
                $message = "Record added successfully.";
                 ...
                 $codes = new Core_Codes();       
                 $docTypeCode =  $codes->getCodeIdByCodeName(Core_Config::get('referencelibrary', 'codes_reference_doctypes_individual'));
    ...
    protected function prepareDetailsControls() {
        ...
        // Checking if the doctype is Individual, then show Employee Association button.
         ...
         if($this->id){
             ...
             if(($docTypeId == $docTypeCode) && (Core_Security::isAllowed('referencelibrary','admin'))){
                $control = new Core_Control_Item_Custom('Employee Association' , array('href' => '/referencelibrary/employeeassoc/assignEmployees/' . $this->id));
    ...
    function attachmentbyidAction() {
        ...
        if (is_numeric($lStrResource)) {
            ...
            $filepath = str_replace('workspace://Local/',Core_Config::get('global','documentstorage_base_path'),$lStrResource);
