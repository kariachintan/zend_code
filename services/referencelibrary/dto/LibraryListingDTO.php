...
class phpnotes_services_referencelibrary_dto_LibraryListingDTO extends phpnotes_services_entity_dto_AbstractServiceDTO {
   ...
   public function getLocation() {
    ...
    //         if ($this->getId() > 0) {
    //             $var=array("'phpnotes_services_ReferenceLibrary_dto_CoverPicDTO'","'phpnotes_services_ReferenceLibrary_dto_RefLibDTO'");
    ...
    //                 array('FIELD' => 'ApplicableType', 'OPERATOR' => 'IN', 'SEARCHSTRING' => "(".implode(",",$var).")", 'LITERAL' => true),

    //                     )
    //             );
    //             $attachmentApplicabilities = EntityUtils::getAll("phpnotes_services_billing_dto_AttachmentApplicabilityDTO", $lObjCriteria);
